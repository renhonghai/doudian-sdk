...
class EditV2Param extends BaseEntity
{
     ...
     * @return mixed
     */
    public function getForceUseQualityList()
    {
        return $this->force_use_quality_list;
    }

    /**
     * @param mixed $force_use_quality_list
     */
    public function setForceUseQualityList($force_use_quality_list): void
    {
        $this->force_use_quality_list = $force_use_quality_list;
    }
