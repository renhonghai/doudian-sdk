...
class ErrNoConstant
{
    ...
    const ERR_NO_SUCCESS = 10000;
    const ERR_NO_SERVICE_ERROR = 20000;
    const ERR_NO_PERMISSION_ERROR = 30001;
    const ERR_NO_PARAMETER_MISSING_ERROR = 40001;
    const ERR_NO_PARAMETER_INVALID_ERROR = 40003;
    const ERR_NO_TOKEN_ERROR = 50001;
    const ERR_NO_TRAFFIC_LIMITED_ERROR = 60000;
    const ERR_NO_API_SERVICE_OFF_ERROR = 70000;
    const ERR_NO_UNKNOWN_ERROR_ERROR = 90000;

    const ERR_NO_MESSAGE = [
        self::ERR_NO_SUCCESS                 => '请求成功',
        self::ERR_NO_SERVICE_ERROR           => '服务不可用',
        self::ERR_NO_PERMISSION_ERROR        => '操作权限不足',
        self::ERR_NO_PARAMETER_MISSING_ERROR => '缺少必选参数',
        self::ERR_NO_PARAMETER_INVALID_ERROR => '非法的参数',
        self::ERR_NO_TOKEN_ERROR             => '平台处理失败',
        self::ERR_NO_TRAFFIC_LIMITED_ERROR   => '触发限流，请稍后重试',
        self::ERR_NO_API_SERVICE_OFF_ERROR   => '接口服务已下线',
        self::ERR_NO_UNKNOWN_ERROR_ERROR     => '其他异常',
    ];

    const ERR_NO_DETAIL_MESSAGE = [
        self::ERR_NO_SUCCESS                 => [],
        self::ERR_NO_SERVICE_ERROR           => [
            'dop.service-error' => '服务调用失败，请稍后重试'
        ],
        self::ERR_NO_PERMISSION_ERROR        => [
        ...
        self::ERR_NO_PARAMETER_MISSING_ERROR => [
        ...
        self::ERR_NO_PARAMETER_INVALID_ERROR => [
        ...
        self::ERR_NO_TRAFFIC_LIMITED_ERROR   => [
            'isv.traffic-limited' => '请求太频繁，请稍后重试'
        ],
        self::ERR_NO_API_SERVICE_OFF_ERROR   => [
        ...
        self::ERR_NO_UNKNOWN_ERROR_ERROR     => [
    ...
    {
        return self::ERR_NO_MESSAGE[$errNo] ?? '';
    }

    public static function getDetailMessage($errNo, $subCode): string
    {
        $errorMessages = self::ERR_NO_DETAIL_MESSAGE[$errNo] ?? [];
